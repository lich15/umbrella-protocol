...
| KT | CONIKS `https://coniks.cs.princeton.edu/`, Trillian `https://transparency.dev/` | 2026-05-14 | split-view при злых свидетелях | `umbrella-kt` | граница выпуска | локальное обнаружение есть, полное закрытие требует обмена наблюдениями |
