...
require_pattern "docs/README.md" "protocol-compliance hardening|security hardening|приведение к документам|усиление безопасности"
...
require_pattern "docs/security/release-notes-v1.1.0.md" "split-view"
require_pattern "docs/security/release-notes-v1.1.0.md" "границей выпуска|release boundaries"
require_pattern "docs/security/release-manifest-v1.1.0.txt" "Public Access"
require_pattern "docs/security/release-manifest-v1.1.0.txt" "Current hardening status|Текущий статус приведения к документам"
require_pattern "docs/security/release-manifest-v1.1.0.txt" "SPKI pinning|SPKI-ключами"
require_pattern "docs/security/release-manifest-v1.1.0.txt" "formal-lint-status-2026-05-13.md"
